# US-FM-007 : Ajouter un produit (Template EPIC 2)
...
### Dépendances
- [x] FM-1 : Créer un compte artisan
...
Toutes les US de l'EPIC 2 (FM-7 à FM-13) partagent ces mêmes critères d'acceptation. Seuls changent :
- Le titre de l'US
